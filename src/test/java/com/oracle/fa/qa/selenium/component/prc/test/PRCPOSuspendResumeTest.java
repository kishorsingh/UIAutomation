...
@Test(groups = { "srg" })
public class PRCPOSuspendResumeTest extends PRCBase{
	String poNumber="";
    ...
    @TestAuthor(createdBy = "bpadhy", createdOn = "01/17/2018", version = "1.0")
    @TestDesc(desc = "Test - Suspend Resume")
    public void testSuspendResumePOReport() {
		reportSuspendResumeOperation(prcBuyerUser2,prcBuyerUser2Pwd,poNumber);
    }


    @Test(dependsOnMethods="testSuspendResumePOReport")
