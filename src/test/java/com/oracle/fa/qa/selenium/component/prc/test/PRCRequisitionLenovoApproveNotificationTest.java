...
public class PRCRequisitionLenovoApproveNotificationTest extends PRCBase {
    ...
    public void testCreateRequisition() {
        //Login as User32
        requisitionNumber =createRequisitionLenovo(prcReqUser32,prcReqUser32Pwd);
    }
    ...
    public void testVerifyBellNotification() {
        checkBellNotificationWithLogin(prcReqUser33,prcReqUser33Pwd,requisitionNumber);
    }
    ...
    public void testRejectRequisition() {
        //Login as User33
        requisitionReportOperations(prcReqUser33,prcReqUser33Pwd, requisitionNumber,false,"approve",false,false);
    }
