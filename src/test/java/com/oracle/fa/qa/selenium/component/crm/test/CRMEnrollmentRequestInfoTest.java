...
@Test(groups = { "srg" })
public class CRMEnrollmentRequestInfoTest extends CRMBase{
    ...
    @TestAuthor(createdBy = "amranaya", createdOn = "02/23/2018", version = "1.0")
    @TestDesc(desc = "Test CRM - Request Information")
    public void testEnrollmentRequestInfo() {
        enrollmentOperations(crmCOMUser1,crmCOMUser1Pwd,null,partnerName,false,"reqInfo",false,false);
        StepReport.info("More Information Requested" );
    }

    @Test(dependsOnMethods="testEnrollmentRequestInfo")
    @TestAuthor(createdBy = "amranaya", createdOn = "02/23/2018", version = "1.0")
    @TestDesc(desc = "Test CRM - Provide Information")
    public void testEnrollmentProvideInfo() {
        enrollmentOperations(crmCOMUser1,crmCOMUser1Pwd,null,partnerName,false,"provideInfo",false,false);
        StepReport.info("Required Information Provided" );
    }

    @Test(dependsOnMethods="testEnrollmentProvideInfo")
    @TestAuthor(createdBy = "amranaya", createdOn = "02/23/2018", version = "1.0")
    @TestDesc(desc = "Test CRM - Approve Enrollment")
    public void testEnrollmentApprove() {
        enrollmentOperations(crmCOMUser1,crmCOMUser1Pwd,null,partnerName,false,"approve",true,false);
        StepReport.info("Required Information Provided" );
    }
