...
@Test(groups = { "srg", "bug25801488", "task_operations" })
public class HCMBug25801488ReAssignHireEmployeeTest extends HCMBase {
    String empName="";
    ...
    @TestAuthor(createdBy = "mputtach", createdOn = "01/17/2018", version = "1.0")
    @TestDesc(desc = "verify Bell Notification for first level approver")
    public void verifyNOBellNotificationLevel0() {
      //checkNOBellNotificationWithLogin("Level0", empName);

    }

    @Test(dependsOnMethods = "verifyNOBellNotificationLevel0")
    @TestAuthor(createdBy = "mputtach", createdOn = "01/17/2018", version = "1.0")
    ...
    @TestAuthor(createdBy = "mputtach", createdOn = "01/17/2018", version = "1.0")
    @TestDesc(desc = "verify Bell Notification for first level approver")
    public void verifyNOBellNotificationLevel1() {
        //checkNOBellNotificationWithLogin("Level1", empName);

    }

    @Test(dependsOnMethods = "verifyNOBellNotificationLevel1")
    @TestAuthor(createdBy = "mputtach", createdOn = "01/17/2018", version = "1.0")
