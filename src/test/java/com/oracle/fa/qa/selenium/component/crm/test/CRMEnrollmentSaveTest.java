...
@Test(groups = { "srg" })
public class CRMEnrollmentSaveTest extends CRMBase{
    ...
    @TestDesc(desc = "Test CRM - Save")
    public void testEnrollmentProvideInfo() {
        enrollmentOperations(crmCOMUser1,crmCOMUser1Pwd,null,partnerName,false,"save",false,false);
        StepReport.info("Enrollment changes Saved" );
    }
