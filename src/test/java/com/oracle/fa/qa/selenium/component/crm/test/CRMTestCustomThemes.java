...
@Test(groups = { "srg" })
public class CRMTestCustomThemes extends CRMBase{
    ...
    @TestAuthor(createdBy = "vevinnak", createdOn = "01/24/2019", version = "1.0")
    @TestDesc(desc = "Test UseDefaultTheme")
    public void testUseDefaultTheme()
    {

        useDefaultTheme(fusionUser,fusionUserPwd);
    }
