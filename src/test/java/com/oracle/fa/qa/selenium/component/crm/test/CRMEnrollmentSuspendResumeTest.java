...
@Test(groups = { "srg" })
public class CRMEnrollmentSuspendResumeTest extends CRMBase {
    ...
    @TestAuthor(createdBy = "amranaya", createdOn = "02/28/2018", version = "1.0")
    @TestDesc(desc = "Test CRM - Suspend Resume Enrollment Request")
    public void testSuspendResume() {
        reportSuspendResumeOperation(crmCOMUser1,crmCOMUser1Pwd,partnerName);
        StepReport.info("Enrollment Suspended and Resumed: " + enrollmentName);
    }
