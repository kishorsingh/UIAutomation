...
@Test(groups = { "srg" })
public class PRCPORequestInfoTest extends PRCBase{
	String poNumber="";
    ...
    public void testPOReportrequestInfo() {
		poReportOperations(prcBuyerUser2,prcBuyerUser2Pwd,poNumber,false,"reqInfo",false,false);
   }
	
	@Test(dependsOnMethods="testPOReportrequestInfo")
    @TestAuthor(createdBy = "bpadhy", createdOn = "01/17/2018", version = "1.0")
    @TestDesc(desc = "Test  - Provide Information")
    public void testPOReportProvideInfo() {
		poReportOperations(prcBuyerUser1,prcBuyerUser1Pwd,poNumber,false,"provideInfo",false,false);
   }

    @Test(dependsOnMethods="testPOReportProvideInfo")
