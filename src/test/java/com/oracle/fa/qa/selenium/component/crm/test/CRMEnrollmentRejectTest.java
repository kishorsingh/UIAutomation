...
@Test(groups = { "srg" })
public class CRMEnrollmentRejectTest extends CRMBase{
    ...
    @TestAuthor(createdBy = "amranaya", createdOn = "02/20/2018", version = "1.0")
    @TestDesc(desc = "Test CRM - Reject Enrollment")
    public void testApproveEnrollment() {
        rejectEnrollment(crmCOMUser1,crmCOMUser1Pwd,partnerName);
        StepReport.info("Enrollment Rejected: " + enrollmentName );
    }
