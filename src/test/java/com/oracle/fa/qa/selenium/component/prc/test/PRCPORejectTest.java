...
@Test(groups = { "srg" })
public class PRCPORejectTest extends PRCBase{
	String poNumber="";
    ...
    public void testCreatePO() {
		//Login as User1
		poNumber=createPO(prcBuyerUser1,prcBuyerUser1Pwd,true);
    }
    ...
    public void testRejectPO() {
		//Login as User1
		poReportOperations(prcBuyerUser2,prcBuyerUser2Pwd,poNumber,false,"reject",false,false);
    }

    @Test(dependsOnMethods="testRejectPO")
    @TestAuthor(createdBy = "leshen", createdOn = "07/19/2018", version = "1.0")
    @TestDesc(desc = "test Bell Notification")
    public void testVerifyBellNotification() {
        checkBellNotificationWithLogin(prcBuyerUser1,prcBuyerUser1Pwd,poNumber);
    }
