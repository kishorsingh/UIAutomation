...
public class ApproveContractsPage extends BasePageObject<ApproveContractsPage> {
	...
	@FindBy(xpath = "//*[@id='adAttBt::icon']")
	WebElement addAttachment;

	@FindBy(xpath = "//*[contains(text(),'Approval of Contract')]")
	WebElement approvalOfContract;
	...
	public void isLoaded() {
		if (PageLoadHelper.waitForElementClickable(approvalOfContract) == null) {
			throw new TestErrorException("The partnerName  is not visible after " +
					Timeout.pageLoadValue().seconds() + " seconds.");
		}

		StepReport.info("Approval Of Contract new page is Loaded");
	}
	...
	public AddComment addComment() {
		...
		DriverUtil.clickByJS(addComment);
		DriverUtil.sleep(2000L);
	...
	public AddAttachments clickAddAttachment() {
		StepReport.info("Add Attachments ");
		DriverUtil.sleep(2000L);
		DriverUtil.clickByJS(addAttachment);
		DriverUtil.sleep(2000L);
		AddAttachments addAttachments = PageFactory.getPage(AddAttachments.class);
		addAttachments.isLoaded();
