...
@Test(groups = { "srg" })
public class CRMCreateDisputeWithdrawApprovedNotification extends CRMBase{
    ...
    public void testWithdrawDispute() {
        operationName = "Withdraw";
        operationsOnDisputeNotification(cdUserName,cdUserPassword,DisputeName,operationName);
        StepReport.info("Create Dispute Application withdrawn Successfully: ");
    }
