...
public class CryptoUtil {
  ...
  public static void main(String[] args) throws Exception {
    final String KEY_FILE = "test\\src\\test\\resources\\scripts\\pwd.key";
    final String PWD_FILE = "test\\src\\test\\resources\\config\\testconfig.properties";
    ...
    p1.put("user", "Real");
    String encryptedPwd = CryptoUtil.encrypt(clearPwd, new File(KEY_FILE));
    ...
    System.out.println
        (CryptoUtil.decrypt(encryptedPwd, new File(KEY_FILE)));
  }
}
