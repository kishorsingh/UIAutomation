...
@Test(groups = { "srg" })
public class CRMEnrollmentDelegateTest extends CRMBase{
    ...
    @TestDesc(desc = "Test CRM - Delegate Enrollment")
    public void testEnrollmentDelegate() {
        reAssignTask(crmCOMUser1,crmCOMUser1Pwd,partnerName,crmCOMUser2,"Delegate");
        StepReport.info("Enrollment Request Delegated to:"+crmCOMUser2 );
    }

    @Test(dependsOnMethods="testEnrollmentDelegate")
    @TestAuthor(createdBy = "amranaya", createdOn = "02/20/2018", version = "1.0")
