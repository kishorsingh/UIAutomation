...
@Test(groups = { "srg" })
public class CRMEnrollmentAdhocRouteTest extends CRMBase {
    ...
    @TestDesc(desc = "Test CRM - ReAssign Enrollment Request")
    public void testAdhocUser() {
        enrollmentOperations(crmCOMUser1,crmCOMUser1Pwd,crmCOMUser2,partnerName,false,"adhoc_user",false,false);
    }

    @Test(dependsOnMethods="testAdhocUser")
    @TestAuthor(createdBy = "amranaya", createdOn = "02/27/2018", version = "1.0")
