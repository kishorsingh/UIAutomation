...
@Test(groups = { "srg" })
public class CRMEnrollmentApprovalTest extends CRMBase{
    ...
    public void testVerifyBellNotification() {
        checkBellNotificationWithLogin(crmCOMUser1,crmCOMUser1Pwd,partnerName);
    }
    ...
    public void testApproveEnrollment() {
        approveEnrollment(crmCOMUser1,crmCOMUser1Pwd,partnerName);
