...
@Test(groups = { "srg" })
public class PRCPOReassignTest extends PRCBase{
	String poNumber="";
    ...
    public void testReAssignPO() {
        reAssignTask(prcBuyerUser2,prcBuyerUser2Pwd,poNumber,"Loraine Norden", "ReAssign");
    }

    @Test(dependsOnMethods="testReAssignPO")
